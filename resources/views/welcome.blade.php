...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link button" href="/ecommerce/public/login">Sign In</a>
                </li>
			</ul>
		</div>
    </nav>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
					<li class="nav-item">
						<a class="nav-link underline" href="/ecommerce/public/shop"><i class="fa fa-shopping-basket"></i> Shop</a>
					</li>
					<li class="nav-item">
                        <a class="nav-link underline" href="{{ route('cart') }}"><i class="fa fa-shopping-cart"></i> Cart</a>
                    </li>
